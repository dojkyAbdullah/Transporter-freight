...
function EditUserModal({ user, currentUserId, onClose, onSaved }) {
  ...
  async function handleSave(e) {
    ...
    try {
      ...
      toast.success(form.newPassword ? "User updated & password changed" : "User updated successfully");
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-xl border border-slate-200 px-3 py-2.5 sm:py-2 pr-10 text-slate-900 bg-white text-base sm:text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-shadow"
              />
              <button
                type="button"
